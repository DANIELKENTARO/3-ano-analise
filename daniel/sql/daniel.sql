...
--
-- Host: 127.0.0.1
-- Generation Time: 18-Jun-2024 às 13:08
...
('324.234.232-34', '(34) 23423-2323', 'dadas@gmail.com', '34644-563', '10110101013');
...
CREATE TABLE `produto` (
  ...
  `pk_id_imagens` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE `produto`
  ...
  ADD KEY `pk_id_imagens` (`pk_id_imagens`);
...
ALTER TABLE `produto`
  ...
  ADD CONSTRAINT `pk_id_imagens` FOREIGN KEY (`pk_id_imagens`) REFERENCES `imagens` (`id_imagens`);
COMMIT;
