...
$sql1 = "SELECT * FROM produto JOIN cores ON produto.fk_id_cores = cores.id_cores JOIN categorias ON produto.fk_id_categorias = categorias.id_categorias WHERE produto = 1";
...
if (mysqli_num_rows($result) >= 1){
    while($row = $result->fetch_assoc()) {
            ...
            echo "<div class='card_texto'> Categoria id: " . $row["opcoes_cores"] . "</div>";
            echo "<div class='card_texto'> Categoria id: " . $row["opcoes_categorias"] . "</div>";
